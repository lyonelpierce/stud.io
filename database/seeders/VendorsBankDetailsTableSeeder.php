...
class VendorsBankDetailsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $vendorBankRecords = [
            ...
            ['id'=>2, 'vendor_id'=>2, 'bank_name'=>'Pichincha', 'bank_account_number'=>'1056552661', 'bank_account_name'=>'Erika Pierce', 'bank_account_type'=>'Ahorros', 'bank_account_document'=>'0922300421']
        ];
